...
# <p align="center"> План на автоматизацию </p>
    Для начала думаю стоит описать задачу и полный путь того, что происходит, когда юзер совершает запись на курс Тестировщик ПО. 
<br>
...
<br>
    ...
    Учитывая всё вышесказанное, уже можно составить план на распределение времени и ресурсов для проверки сценариев для автоматизированного тестирования.
<br>
<br>
...
<br>
    ...
    По сути, начало у каждого сценария всегда одинаковое. Нам нужно зайти на сайт и прокликать до заполнения формы или ввести через поиск и дойти до заполнения формы. 
...
<br>
        ...
        Данные можнно ввести правильно, но это не значит, что они будут корректными. Для проверки номера телефона можно добавить проверку номера путём ввода смс-кода. Имя можно уточнить уже во время разговора во время звонка от менеджера. 
<br>
...
<br>
    ...
    Безусловно, для каждого пункта можно найти и альтернативный вариант. Всё обсуждаемо в пользу лучшего и быстрого выполнения задачи. 
<br>
...
<br>
        ...
        Возможно, все эти навыки в нужной степени могут присутствовать и в одном QA Инженере.
<br>
...
<br>
    ...
    В данном плане не рассматривались юзабилити-тесты и привлечение для них дизайнеров, психологов и специалистов аналитики. Всё, конечно, зависит от бюджета и времени. Данная стратегия разработана только для автотестов (возможно, с небольшим вмешательсвом мануального тестирования).  